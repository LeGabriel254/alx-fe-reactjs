import React from 'react'
 ...
 function UserProfile() {
  return (
   ...
   <img src="https://via.placeholder.com/150 rounded-full w-36 h-36 mx-auto sm:w-24 h-24 md:w-36 h-36"  alt="User"/>
   <h1 className='Name text-xl text-blue-800 my-4 sm:text-lg md:tex-txl sm:text-sm md:text-base'>John Doe</h1>
