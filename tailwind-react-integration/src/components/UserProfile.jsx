import React from 'react'
 ...
 function UserProfile() {
  return (
   <div  className='container bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg sm:p-4 md:p-8 max-w-xs on small screens and max-w-sm on medium screens and above'>
